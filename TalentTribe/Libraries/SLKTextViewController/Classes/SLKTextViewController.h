...
NS_CLASS_AVAILABLE_IOS(7_0) @interface SLKTextViewController : TTCustomViewController <UITextViewDelegate, UITableViewDelegate, UITableViewDataSource, UICollectionViewDelegate, UICollectionViewDataSource, UIGestureRecognizerDelegate, UIAlertViewDelegate>
...
- (void)slk_setScrollView:(UIScrollView *)scrollView;
