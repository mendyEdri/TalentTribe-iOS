...
- (UIImage *)resizedImageToWidth:(CGFloat)targetWidth {
    ...
    return [self resizedImage:targetSize interpolationQuality:kCGInterpolationHigh];
}
...
- (void)resizedImageToWidth:(CGFloat)targetWidth withCompletion:(SimpleResultBlock)completion {
    ...
    CGFloat targetHeight = self.size.height * scaleFactor;
    CGSize targetSize = CGSizeMake(targetWidth, targetHeight);
    UIImage *image = [self resizedImage:targetSize interpolationQuality:kCGInterpolationHigh];
    if (completion) {
