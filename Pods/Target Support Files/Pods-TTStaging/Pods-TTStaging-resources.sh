...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "TURecipientBar/TURecipientBar/recipient-selected.png"
  install_resource "TURecipientBar/TURecipientBar/recipient-selected@2x.png"
  install_resource "TURecipientBar/TURecipientBar/recipient-selected@3x.png"
  install_resource "TURecipientBar/TURecipientBar/recipient.png"
  install_resource "TURecipientBar/TURecipientBar/recipient@2x.png"
  install_resource "TURecipientBar/TURecipientBar/recipient@3x.png"
fi
